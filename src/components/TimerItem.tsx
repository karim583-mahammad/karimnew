...
//     const playAudio = () => {
//       timerAudio.play(true).catch(console.error);
//     };

//     playAudio();
//     audioInterval = window.setInterval(playAudio, 100); 
...
//         onClick: () => {
//           if (audioInterval) {
//             clearInterval(audioInterval); // Stop the loop
//           }
//           timerAudio.stop(); // Stop the current sound
